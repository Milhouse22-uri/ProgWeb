<?php
require_once("../models/privilegios.php");
$app = new Privilegios();
...
switch ($action) {
    case 'create':
        if (isset($_POST['enviar'])) {
            ...
            $data = $app -> read();
            include_once("./views/privilegios/index.php");
        }else{
            include_once("./views/privilegios/_form.php");
        }
        break;
    ...
    case 'update':
        if (isset($_POST['enviar'])) {
            ...
            $id = $_GET['id'];
            $data = $app -> readOne($id);
            include_once("./views/privilegios/_form_update.php");
        }
        break;
