...
<form method="POST" action="accesorios.php?action=create" class="p-4 bg-light rounded shadow-sm">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="precio" name="precio" placeholder="100.00">
        </div>
        <div class="mb-3">
            <label for="descripcion" class="form-label">Descripcion</label>
            <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Descripcion del accesorio">
        </div>
        <div class="mb-3">
